...
| 论文撰写 | `roles/论文手/SKILL.md` | 交付 LaTeX 源码项目、编译 PDF 与构建清单 |
...
| 连续域极值、首次事件或全过程约束 | [数值极值与事件验证](数值极值与事件验证.md)，区分局部求解、覆盖证据及严格证明 |
| 离散优化、多阶段决策、策略枚举或动作删减 | [决策空间与策略验证](决策空间与策略验证.md)，审查关键可选动作、可观测状态和策略范围 |
